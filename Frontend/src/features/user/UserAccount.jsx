...
const UserAccount = () => {
    ...
    try {
      ...
      if (user) {
        ...
        setFormData({
          ...
          followingCount: user._count?.companiesFollowed ?? 0,
          email: user.email || '',
  ...
  const handleSave = async () => {
    ...
    // If email changed, ask for password first
  ...
  const handleCancel = () => {
    ...
    if (originalData) {
      setFormData({
        ...
        name: originalData.fullName?.split(' ')[0] || '',
        lastName: originalData.fullName?.split(' ').slice(1).join(' ') || '',
        followingCount: originalData._count?.companiesFollowed ?? 0,
        ...
        <Box sx={{ 
          ...
          <Box sx={{ 
            ...
            <Typography variant="body1" sx={{ color: COLORS.textPrimary }}>
              Following : <strong style={{ color: COLORS.primary }}>{formData.followingCount}</strong> 
            </Typography>
          </Box>
        </Box>
          ...
          <Box sx={{ 
            ...
            >
              ...
              <Box sx={{ display: 'flex', justifyContent: 'space-between', mt: 2 }}>
                <PrimaryButton 
                  onClick={()=> navigate('/user/PasswordReset')}
                >
                  Forget Password ?
                </PrimaryButton>
                <PrimaryButton 
