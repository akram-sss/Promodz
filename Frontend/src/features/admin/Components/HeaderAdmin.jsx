...
const ROUTE_MAP = {
  ...
  '/admin/SiteManagment': 'SiteManagment',
...
const REVERSE_MAP = {
  ...
  SiteManagment: '/admin/SiteManagment',
...
const HeaderAdmin = () => {
  ...
  const userData = user ? {
    username: user.username || user.fullName || 'Admin',
  ...
  return (
    <HeaderContainer>
      ...
      <UserSection>
        <UserInfo onClick={() => navigate('/admin/AdminAccount')}>
          <UserDetails>
